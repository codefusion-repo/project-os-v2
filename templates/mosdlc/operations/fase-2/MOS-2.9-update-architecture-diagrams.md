# MOS-2.9 update-architecture-diagrams
...
MOSDLC:
  ...
  Classification: variant; merge-candidate (con MOS-2.1 vía acción crear/actualizar)
...
OPERATION:
  Draft updates or creation routes for architecture diagrams from existing design docs and Fase 1 requirements.
...
LIVE_STATE:
  Read existing architecture diagrams, Fase 1 requirements, gap audit findings, ADRs, cited docs, and PM decisions live.
  Treat generated updates as draft content until the PM approves an exact write route.
  Store no issue, PR, branch, commit, validation, release, deployment, or planning state in durable files.

DO:
  Draft architecture diagram updates that preserve valid existing design and close evidence-backed gaps.
  Identify what is being created, changed, or left untouched, and surface conflicts for PM decision.
