...
MOSDLC:
  ...
  Classification: variant; merge-candidate (con MOS-2.2 vía acción crear/actualizar)
...
OPERATION:
  Draft updates or creation routes for UI/UX design documentation from existing docs and Fase 1 requirements.
...
LIVE_STATE:
  Read existing UI/UX docs, Fase 1 requirements, gap audit findings, design assets, cited docs, and PM decisions live.
  Treat generated updates as draft content until the PM approves an exact write route.
  Store no issue, PR, branch, commit, validation, release, deployment, or planning state in durable files.

DO:
  Draft UI/UX updates that preserve valid existing design and close evidence-backed gaps.
  Identify affected flows, screens, states, accessibility notes, assumptions, and PM decisions needed.
