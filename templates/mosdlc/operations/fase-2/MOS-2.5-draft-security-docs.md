...
OPERATION:
  Draft security design documentation based on OWASP and the 8 security domains from stable Fase 1 requirements.
...
LIVE_STATE:
  Read Fase 1 requirements, threat assumptions, existing security notes, target constraints, cited docs, and PM decisions live.
  Treat generated security docs as draft content until the PM approves an exact write route.
  Store no issue, PR, branch, commit, validation, release, deployment, or planning state in durable files.

DO:
  Draft security documentation covering OWASP-relevant surfaces, the 8 security domains, trust boundaries, auth, input validation, secrets handling, logging, dependency risk, and open risks.
  Redact any secret-looking value as [REDACTED] and report only path, variable name, and risk type when configuration evidence is needed.
