...
OPERATION:
  Draft coding standards documentation from stable Fase 1 requirements and design source basis.
...
LIVE_STATE:
  Read Fase 1 requirements, existing conventions, language/framework constraints, cited docs, and PM decisions live.
  Treat generated coding standards as draft content until the PM approves an exact write route.
  Store no issue, PR, branch, commit, validation, release, deployment, or planning state in durable files.

DO:
  Draft coding standards covering style, architecture boundaries, testing expectations, error handling, security-sensitive coding, and review criteria.
  Separate target-owned conventions from proposed standards and name PM decisions still needed.
