...
MOSDLC:
  ...
  Classification: variant; merge-candidate (con MOS-3.16 a MOS-3.18 vía ASSET_TYPE)
...
OPERATION:
  ...
  Source map summary: Draftea el asset prompt para solicitar un asset 2D a un destinatario externo. Obtener assets 2D sin tratar al creador como actor kernel. Prompt PM-facing con objetivo, restricciones y formato de entrega.
