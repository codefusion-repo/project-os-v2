# MOS-3.21 process-audio-asset-delivery
...
MOSDLC:
  ...
  Classification: variant; merge-candidate (con MOS-3.19 vía ASSET_TYPE)
...
OPERATION:
  ...
  Source map summary: Procesa la entrega de un asset de audio y la mapea a tareas técnicas o drafts. Integrar assets recibidos al ciclo de desarrollo. Clasifica la entrega hacia issue, corrección o follow-up.
...
DO:
  ...
  ASSET_TYPE is fixed by this template as audio; do not collapse Fase 3 asset variants unless a separate issue approves it.
