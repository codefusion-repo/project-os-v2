...
OPERATION:
  Process recommended performance improvements into prioritized work.
  Source map summary: Procesa las mejoras de rendimiento recomendadas. Convertir recomendaciones en trabajo priorizado. Clasifica mejoras hacia issues o follow-ups.
...
LIVE_STATE:
  Read AUDIT_RESULT from MOS-6.3 and any related performance evidence live.
  Store no issue, PR, branch, commit, validation, release, deployment, or planning state in durable files.

DO:
  Classify AUDIT_RESULT performance recommendations as new implementation work, non-blocking follow-up, or PM decision only when evidence supports that route.
  ...
  Do not apply optimizations, edit files, create issues, or comment on GitHub.
