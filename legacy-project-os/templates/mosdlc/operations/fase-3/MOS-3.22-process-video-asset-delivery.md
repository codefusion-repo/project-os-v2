...
OPERATION:
  ...
  Source map summary: Procesa la entrega de un asset de video y la mapea a tareas técnicas o drafts. Integrar assets recibidos al ciclo de desarrollo. Clasifica la entrega hacia issue, corrección o follow-up.
...
DO:
  ...
  ASSET_TYPE is fixed by this template as video; do not collapse Fase 3 asset variants unless a separate issue approves it.
