...
MOSDLC:
  ...
  Classification: variant; merge-candidate (con MOS-2.4 vía acción crear/actualizar)
...
OPERATION:
  Draft updates or creation routes for coding standards documentation from existing docs and Fase 1 requirements.
...
LIVE_STATE:
  Read existing coding standards, Fase 1 requirements, gap audit findings, target conventions, cited docs, and PM decisions live.
  Treat generated updates as draft content until the PM approves an exact write route.
  Store no issue, PR, branch, commit, validation, release, deployment, or planning state in durable files.

DO:
  Draft coding standards updates that preserve valid existing conventions and close evidence-backed gaps.
  Identify affected style, architecture, testing, error handling, security-sensitive coding, and review criteria.
