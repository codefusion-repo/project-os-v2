# MOS-2.3 draft-data-algorithms-docs
...
OPERATION:
  Draft data-structure and algorithm documentation from stable Fase 1 requirements and design source basis.
...
LIVE_STATE:
  Read Fase 1 requirements, existing data model notes, algorithm constraints, cited docs, and PM decisions live.
  Treat generated data and algorithm docs as draft content until the PM approves an exact write route.
  Store no issue, PR, branch, commit, validation, release, deployment, or planning state in durable files.

DO:
  Draft data structures, algorithms, invariants, complexity concerns, persistence assumptions, and unresolved design questions.
  Tie each structure or algorithm to source basis and call out any requirement that lacks design support.
