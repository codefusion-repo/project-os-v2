...
MOSDLC:
  ...
  Classification: variant; merge-candidate (con MOS-2.5 vía acción crear/actualizar)
...
OPERATION:
  Draft updates or creation routes for OWASP and 8-domain security documentation from existing docs and Fase 1 requirements.
...
LIVE_STATE:
  Read existing security docs, Fase 1 requirements, gap audit findings, target constraints, cited docs, and PM decisions live.
  Treat generated updates as draft content until the PM approves an exact write route.
  Store no issue, PR, branch, commit, validation, release, deployment, or planning state in durable files.

DO:
  Draft security doc updates that preserve valid existing security design and close evidence-backed gaps.
  Cover OWASP-relevant surfaces, the 8 security domains, trust boundaries, auth, input validation, secrets handling, logging, dependency risk, and open risks.
