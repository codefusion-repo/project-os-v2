...
OPERATION:
  Draft UI/UX design documentation from stable Fase 1 requirements and design source basis.
...
LIVE_STATE:
  Read Fase 1 requirements, product constraints, existing UI/UX notes, design assets, cited docs, and PM decisions live.
  Treat generated UI/UX docs as draft content until the PM approves an exact write route.
  Store no issue, PR, branch, commit, validation, release, deployment, or planning state in durable files.

DO:
  Draft UI/UX documentation covering flows, screens, states, accessibility, constraints, assumptions, and open questions.
  Tie design choices to source basis and separate confirmed requirements from PM decisions still needed.
