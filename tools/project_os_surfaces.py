...
SURFACES = (
    ProjectOSSurface(
        ...
        messages={
            ...
            "unknown_change_class": "change class desconocida",
            "incompatible_change_class": "change class incompatible con el workflow",
            "change_class_required_for_mutation": "un workflow con mutacion requiere una change_class declarada",
            "density_downgrade_blocked": "un nivel de hidratacion explicito no puede reducir la densidad contractual de la clase",
            "unknown_provenance_reason": "razon de procedencia detallada desconocida",
            "known": "conocidos",
    ...
    ProjectOSSurface(
        ...
        messages={
            ...
            "unknown_change_class": "unknown change class",
            "incompatible_change_class": "change class incompatible with the workflow",
            "change_class_required_for_mutation": "a mutating workflow requires a declared change_class",
            "density_downgrade_blocked": "an explicit hydration level cannot reduce the class contractual density",
            "unknown_provenance_reason": "unknown detailed-provenance reason",
            "known": "known",
