...
This compact documentation points to the English kernel instead of duplicating it.
...
- [Reproducible context benchmark](context-benchmark.md): session-context sizes measured against public conventional stacks, plus the internal hydration profile, with declared method and date.
