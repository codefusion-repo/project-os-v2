...
After resolution, open the selected resolution, applicable limits and evidence, output and artifact, exact template, requested skills, minimum live evidence, and target sources required by scope, validation, or source basis. Later reads require the same justification and never expose absolute machine paths or full bodies. Default PM-facing traceability is the output's reviewed evidence; no reason replaces evidence or gates.
