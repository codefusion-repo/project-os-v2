...
**Does:** Draft a human production-readiness QA checklist without executing deployment or release work.
**For:** Complete this lifecycle outcome through the selected workflow with explicit evidence and boundaries.
**How:** Draft human-verifiable readiness checks for functionality, docs, security posture, configuration hygiene, observability, rollback awareness, and known blockers.
