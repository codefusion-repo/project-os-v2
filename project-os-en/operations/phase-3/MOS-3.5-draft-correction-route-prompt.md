...
`WORK_UNIT` with the corrected live unit and keep its `CHANGE_CLASS`. Findings
travel by intent: the material breach and its observable criterion are binding;
the reviewer's wording and solution proposals are advisory. Browser
