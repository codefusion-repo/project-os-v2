...
MOSDLC operation `request-video-asset` · Phase 3 — Implementation · Risk: low.
...
**Connections:** Previous: asset need detected. Next: MOS-3.22 upon delivery arrival. Recommended: MOS-3.22.
