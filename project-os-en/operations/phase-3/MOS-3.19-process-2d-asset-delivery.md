# MOS-3.19 — Process a 2D asset delivery

MOSDLC operation `process-2d-asset-delivery` · Phase 3 — Implementation · Risk: low.
...
**Does:** Processes the delivery of a 2D asset and maps it to technical tasks or drafts.
...
**Connections:** Previous: MOS-3.15. Next: MOS-3.4, MOS-3.5 or MOS-3.3. Recommended: MOS-3.4.
