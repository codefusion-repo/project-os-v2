...
**Does:** Draft the asset prompt to request a 3D asset from an external recipient.
**For:** To get 3D assets without treating the creator as a kernel actor.
...
**Connections:** Previous: asset need detected. Next: MOS-3.20 upon delivery arrival. Recommended: MOS-3.20.
