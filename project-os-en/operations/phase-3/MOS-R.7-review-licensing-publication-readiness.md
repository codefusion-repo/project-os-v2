...
**Deliver:** output.status_result. In case of unreadable criteria or evidence, or pending publication decision, fail closed: report with `output.status_result` and return the decision to the PM.

**Connections:** Previous: MOS-3.10 or publication preparation. Next: MOS-R.22. Recommended: MOS-R.22.
