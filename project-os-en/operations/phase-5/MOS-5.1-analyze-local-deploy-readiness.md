...
**Does:** Analyze local deployment readiness from target-owned notes and repository evidence without configuring or deploying anything.
**For:** Complete this lifecycle outcome through the selected workflow with explicit evidence and boundaries.
**How:** Identify local-only prerequisites, missing target-owned notes, dependency/service assumptions, database or seed-data readiness, local validation expectations, and secret/config risk types.
