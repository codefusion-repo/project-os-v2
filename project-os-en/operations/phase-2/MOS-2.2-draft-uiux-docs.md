# MOS-2.2 — Draft ui/ux docs

MOSDLC operation `draft-uiux-docs` · Phase 2 — Design · Risk: low.
...
**Does:** Draft UI/UX design documentation from stable Phase 1 requirements and design source basis.
**For:** Complete this lifecycle outcome through the selected workflow with explicit evidence and boundaries.
**How:** Draft UI/UX documentation covering flows, screens, states, accessibility, constraints, assumptions, and open questions.
