...
**Does:** Draft updates or creation routes for UI/UX design documentation from existing docs and Phase 1 requirements.
**For:** Complete this lifecycle outcome through the selected workflow with explicit evidence and boundaries.
**How:** Draft UI/UX updates that preserve valid existing design and close evidence-backed gaps.
