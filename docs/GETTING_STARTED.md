...
- El agente lee el kernel automáticamente desde su sistema de archivos local y recibe un "route-prompt" (ej. redactado por `templates/operations/07-draft-issue-implementation-route-prompt.md`).
