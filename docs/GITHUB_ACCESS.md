...
local de `gh` y las expectativas de acceso de mínimo privilegio. No cubre
integraciones externas ni automatización de permisos.
...
- **Browser Chat**: Solo debe solicitar contexto u observar repositorios en modo lectura. Está acordonado para actuar en modo *draft-only*, sin importar las capacidades técnicas de la superficie.
