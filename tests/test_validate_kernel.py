...
KERNEL_ID_REFERENCE_ALLOWLIST = {
    ...
    ("tests/test_validate_kernel.py", "actor.does_not_exist"): "negative unknown-selector fixture (self)",
    ("tests/test_validate_kernel.py", "actor.fake"): "negative unknown-selector fixture (self)",
    ("tests/test_validate_kernel.py", "actor.nope"): "negative unknown-selector fixture (self)",
    ("tests/test_validate_kernel.py", "actor.test"): "negative unknown-selector fixture (self)",
    ("tests/test_validate_kernel.py", "actor.nonexistent"): "negative unknown-selector fixture (self)",
    ("tests/test_validate_kernel.py", "mode.does_not_exist"): "negative unknown-selector fixture (self)",
    ("tests/test_validate_kernel.py", "mode.nope"): "negative unknown-selector fixture (self)",
    ("tests/test_validate_kernel.py", "mode.imaginary"): "negative unknown-selector fixture (self)",
    ("tests/test_validate_kernel.py", "workflow.does_not_exist"): "negative unknown-selector fixture (self)",
    ("tests/test_validate_kernel.py", "workflow.nope"): "negative unknown-selector fixture (self)",
    ("tests/test_validate_kernel.py", "workflow.fake"): "negative unknown-selector fixture (self)",
}
