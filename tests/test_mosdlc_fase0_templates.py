...
def test_mosdlc_fase0_migration_does_not_expand_kernel_or_later_phases() -> None:
    ...
    assert not any(path.startswith("templates/mosdlc/operations/fase-1/") for path in changed_files)
