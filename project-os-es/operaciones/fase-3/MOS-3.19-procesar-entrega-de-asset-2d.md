# MOS-3.19 — Procesar la entrega de un asset 2D

Operación MOSDLC `process-2d-asset-delivery` · Fase 3 — Implementación · Riesgo: low.
...
**Hace:** Procesa la entrega de un asset 2D y la mapea a tareas técnicas o drafts.
...
**Conexiones:** Antes: MOS-3.15. Después: MOS-3.4, MOS-3.5 o MOS-3.3. Recomendada: MOS-3.4.
