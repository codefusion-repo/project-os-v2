# MOS-3.17 — Solicitar un asset de audio

Operación MOSDLC `request-audio-asset` · Fase 3 — Implementación · Riesgo: low.
...
**Hace:** Draftea el asset prompt para solicitar un asset de audio a un destinatario externo.
**Para:** Obtener assets de audio sin tratar al creador como actor kernel.
...
**Conexiones:** Antes: necesidad de asset detectada. Después: MOS-3.21 al llegar la entrega. Recomendada: MOS-3.21.
