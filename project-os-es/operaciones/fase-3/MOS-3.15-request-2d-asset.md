# MOS-3.15 — Solicitar un asset 2D

Operación MOSDLC `request-2d-asset` · Fase 3 — Implementación · Riesgo: low.
...
**Para:** Obtener assets 2D sin tratar al creador como actor kernel.
...
**Conexiones:** Antes: necesidad de asset detectada. Después: MOS-3.19 al llegar la entrega. Recomendada: MOS-3.19.
