# MOS-3.21 — Procesar la entrega de un asset de audio

Operación MOSDLC `process-audio-asset-delivery` · Fase 3 — Implementación · Riesgo: low.
Contrato común: `project-os-es/operaciones/README.md` (resolución de kernel, estado vivo, validación, no-autorización, fail-closed, secretos).

- Superficie: browser_chat → human_pm
- Kernel: workflow.pm_intake · mode.review_only · output.status_result (+output.route_prompt, output.pm_command_bundle)
- Evidencia: evidence.source_basis, evidence.repo_state
- Compatibilidad: `legacy-project-os/templates/operations/32-process-design-asset-delivery.md`
- Aprobación PM: No (draft-only)

**Hace:** Procesa la entrega de un asset de audio y la mapea a tareas técnicas o drafts.
...
**Conexiones:** Antes: MOS-3.17. Después: MOS-3.4, MOS-3.5 o MOS-3.3. Recomendada: MOS-3.4.
