# MOS-5.10 — Draftear comandos de despliegue local

Operación MOSDLC `draft-local-deploy-commands` · Fase 5 — Despliegue local / staging / producción · Riesgo: medium.
...
**Conexiones:** Antes: MOS-5.3. Después: MOS-5.11 o ejecución del Humano PM. Recomendada: MOS-5.11 solo con aprobación exacta.
