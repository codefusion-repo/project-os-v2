# MOS-5.2 — Draftear el checklist de despliegue local

Operación MOSDLC `draft-local-deploy-checklist` · Fase 5 — Despliegue local / staging / producción · Riesgo: medium.
...
**Hace:** Draftea el checklist humano de despliegue local nombrando variables y pasos, nunca valores secretos.
**Para:** Guiar los pasos humanos del despliegue local.
**Cómo:** Consume los gaps humanos de MOS-R.11 para la misma unidad, ref y
entorno `local`. Conserva resultados aún válidos con sus fuentes y
...
**Conexiones:** Antes: MOS-5.1. Después: MOS-5.3. Recomendada: MOS-5.3.
