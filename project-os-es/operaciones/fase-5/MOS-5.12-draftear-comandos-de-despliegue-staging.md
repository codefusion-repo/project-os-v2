# MOS-5.12 — Draftear comandos de despliegue staging

Operación MOSDLC `draft-staging-deploy-commands` · Fase 5 — Despliegue local / staging / producción · Riesgo: medium.
...
**Hace:** Draftea el bundle de comandos de despliegue staging desde los comandos target-owned de Project-specific notes.
**Para:** Preparar la ejecución del despliegue staging sin inventar comandos.
**Cómo:** Delega el bundle en MOS-R.12 con `TARGET_ENVIRONMENT=staging`
...
**Conexiones:** Antes: MOS-5.6. Después: MOS-5.13 o ejecución del Humano PM. Recomendada: MOS-5.13 solo con aprobación exacta.
