# MOS-2.13 — Actualizar documentación de seguridad

Operación MOSDLC `update-security-docs` · Fase 2 — Diseño · Riesgo: low.
...
**Hace:** Actualiza o crea documentación de seguridad basada en OWASP y los 8 dominios desde la documentación existente y la Fase 1.
