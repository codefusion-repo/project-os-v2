# MOS-2.1 — Draftear diagramas de arquitectura

Operación MOSDLC `draft-architecture-diagrams` · Fase 2 — Diseño · Riesgo: low.
...
**Hace:** Draftea diagramas de arquitectura (por ejemplo Mermaid en docs) desde los requisitos de la Fase 1.
