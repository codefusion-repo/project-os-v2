# MOS-2.2 — Draftear documentación UI/UX

Operación MOSDLC `draft-uiux-docs` · Fase 2 — Diseño · Riesgo: low.
...
**Hace:** Draftea documentación de diseño UI/UX desde los requisitos de la Fase 1.
